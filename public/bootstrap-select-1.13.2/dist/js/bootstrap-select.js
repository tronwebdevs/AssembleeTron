...
(function ($) {
  ...
  Selectpicker.DEFAULTS = {
    noneSelectedText: 'Nessuna classe selezionata',
    noneResultsText: 'Nessun risultato corrisponde a {0}',
    countSelectedText: function (numSelected, numTotal) {
      return (numSelected == 1) ? "{0} classe selezionata" : "{0} classi selezionate";
    },
